...
const campusFoodDB = {
        "chicken adobo": {
            ...
            imageUrl: "assets/imgs/adobo.jpg" // <-- PUT YOUR IMAGE PATH HERE
        },
        "french fries": {
            product_name_en: "Stall Special Fries",
            allergens_hierarchy: [], // No common allergens
            imageUrl: "assets/imgs/fries.jpg" // <-- PUT YOUR IMAGE PATH HERE
        },
        "cheese sandwhich": {
            product_name_en: "Cheese Sandwich",
            allergens_hierarchy: ["en:milk", "en:gluten"], // From cheese and bread
            imageUrl: "assets/imgs/cheese-sandwich.jpg" // <-- PUT YOUR IMAGE PATH HERE
        },
        "pesto pasta": {
            product_name_en: "Pesto Pasta",
            allergens_hierarchy: ["en:tree nuts", "en:milk"], // From cheese and bread
            imageUrl: "assets/imgs/pesto-pasta.jpg" // <-- PUT YOUR IMAGE PATH HERE
        }
    };